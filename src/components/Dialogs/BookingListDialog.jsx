            ...
            <table className="min-w-full table-auto border-collapse text-[8px] lg:text-[15px]">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-black text-[8px] sm:text-base">
                    Created By
                  </th>
                  <th className="border border-black text-[8px] sm:text-base">
                    Created At
                  ...
                  <th className="border border-black text-[8px] sm:text-base text-center">
                    Subject
                  </th>
                  <th className="border border-black text-[8px] sm:text-base text-center">
                    Time
                ...
                {rows
                  ...
                  .map((row) => (
                    <tr key={row.id} className="border-b">
                      <td className="border border-black text-[8px] sm:text-base">
                      ...
                      <td className="border border-black text-[8px] sm:text-base text-center">
