...
export default function SectionListDialog({
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-4xl bg-white p-4 rounded-md shadow-lg">
            ...
            <table className="min-w-full table-auto border-collapse">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border px-2 py-1 text-center">Section ID</th>
                  <th className="border px-2 py-1 text-center">Section Name</th>
                  <th className="border px-2 py-1 text-center">Section Type</th>
